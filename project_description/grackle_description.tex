...
%% The field arrays use an enhanced \texttt{NumPy} array,
%% provided by \yt{}, that endows values with symbolically expressable
...
%% For example, to calculate the cooling time for a \texttt{FluidContainer}
%% object, \texttt{fc}, the syntax is
%% \texttt{fc.calculate\_cooling\_time()}.
%% The interface layer
